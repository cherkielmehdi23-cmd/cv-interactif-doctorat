...
const routes: { id: SectionId; href: string; icon: typeof GraduationCap; count: string; status: "VERIFIED" | "CONTROLLED" | "REVIEW" | "PRIVATE" }[] = [
  { id:"academic", href:"/formation-academique", icon:GraduationCap, count:"4", status:"CONTROLLED" },
  { id:"experience", href:"/experiences-professionnelles", icon:FolderCheck, count:"1", status:"CONTROLLED" },
  { id:"internships", href:"/stages", icon:ScrollText, count:"9", status:"REVIEW" },
  { id:"certificates", href:"/formations-certificats", icon:Medal, count:"7", status:"CONTROLLED" },
  { id:"communications", href:"/communications-scientifiques", icon:BookOpenCheck, count:"2", status:"CONTROLLED" },
  { id:"activities", href:"/activites-para-universitaires", icon:LibraryBig, count:"8", status:"REVIEW" },
  { id:"recommendations", href:"/lettres-recommandation", icon:ScrollText, count:"5", status:"PRIVATE" },
  { id:"thesis", href:"/memoire-master", icon:FileText, count:"4", status:"CONTROLLED" },
  { id:"project", href:"/projet-sii-ml-chu", icon:FolderCheck, count:"239", status:"CONTROLLED" },
];

export default function Home({ locale }: { locale: Locale }) {
  const t = messages[locale];
  const homeIntro = "Titulaire d’un Master d’excellence en Management des Systèmes d’Information Intelligents, je développe un parcours à l’interface des sciences de gestion, du management et des systèmes d’information. Depuis 2019, j’exerce au sein du Service Audit Interne et Contrôle de Gestion du CHU Mohammed VI d’Oujda. Mon expérience professionnelle, mon mémoire et mes travaux de formation nourrissent une démarche de recherche appliquée, ouverte à des projets doctoraux dans ces domaines.";
