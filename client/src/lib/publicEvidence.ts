...
export type PublicEvidence = { id: string; title: string; source: string; preview: string; download: string; sections: SectionId[]; year: string; type: string; organization: string; previewRedressed?: boolean };

type EvidenceSeed = Omit<PublicEvidence, "year" | "type" | "organization">;

const seeds: EvidenceSeed[] = [
  { id:"ACA-01-MASTER", title:"Master — attestation de réussite et relevé", source:"ATTESTATION DE REUSSITE ET RELEVE DE NOTES MASTER.pdf", preview:"/manus-storage/safe-aca-01-master_d1259baa.jpg", download:"/manus-storage/safe-aca-01-master_d1259baa.jpg", sections:["academic","registry"], previewRedressed:true },
  { id:"ACA-02-LICENSE-RECORD", title:"Licence — relevé ou attestation AEMS2I", source:"licence AEMS2I.pdf", preview:"/manus-storage/safe-aca-02-license-record_5307490b.jpg", download:"/manus-storage/safe-aca-02-license-record_5307490b.jpg", sections:["academic","registry"], previewRedressed:true },
  { id:"ACA-03-LICENSE-DIPLOMA", title:"Licence d’excellence — diplôme", source:"licence d_excellence diplome mehdi.pdf", preview:"/manus-storage/safe-aca-03-license-diploma_1e8ebe80.jpg", download:"/manus-storage/safe-aca-03-license-diploma_1e8ebe80.jpg", sections:["academic","registry"], previewRedressed:true },
  ...
  { id:"ACA-08-BAC-RECORD", title:"Baccalauréat — relevé de notes", source:"Relevé note BAC.jpg", preview:"/manus-storage/safe-aca-08-bac-record-oriented_6e586b0b.jpg", download:"/manus-storage/safe-aca-08-bac-record-oriented_6e586b0b.jpg", sections:["academic","registry"], previewRedressed:true },
