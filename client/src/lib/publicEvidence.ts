...
export type PublicEvidence = { id: string; title: string; source: string; preview: string; download: string; sections: SectionId[]; year: string; type: string; organization: string; previewRedressed?: boolean; curriculum?: string[]; skills?: string[]; summary?: string; isDiploma?: boolean };

type EvidenceSeed = Omit<PublicEvidence, "year" | "type" | "organization">;

const seeds: EvidenceSeed[] = [
  { id:"ACA-01-MASTER", title:"Master — attestation de réussite et relevé", source:"ATTESTATION DE REUSSITE ET RELEVE DE NOTES MASTER.pdf", preview:"/manus-storage/safe-aca-01-master_d1259baa.jpg", download:"/manus-storage/safe-aca-01-master_d1259baa.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Management des systèmes d’information intelligents", "Recherche appliquée et mémoire de master"], skills:["Management des SI", "Analyse de données", "Recherche appliquée"], isDiploma:true },
  { id:"ACA-02-LICENSE-RECORD", title:"Licence — relevé ou attestation AEMS2I", source:"licence AEMS2I.pdf", preview:"/manus-storage/safe-aca-02-license-record_5307490b.jpg", download:"/manus-storage/safe-aca-02-license-record_5307490b.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Analyse économique", "Management des systèmes d’information"], skills:["Analyse économique", "Management", "Systèmes d’information"] },
  { id:"ACA-03-LICENSE-DIPLOMA", title:"Licence d’excellence — diplôme", source:"licence d_excellence diplome mehdi.pdf", preview:"/manus-storage/safe-aca-03-license-diploma_1e8ebe80.jpg", download:"/manus-storage/safe-aca-03-license-diploma_1e8ebe80.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Analyse économique", "Management des systèmes d’information"], skills:["Analyse économique", "Management", "Systèmes d’information"], isDiploma:true },
  { id:"ACA-04-BTS-DIPLOMA", title:"BTS Gestion PME/PMI — diplôme", source:"Diplôme BTS Gestion PME _PMI.jpg", preview:"/manus-storage/safe-aca-04-bts-diploma-oriented_d4c065c3.jpg", download:"/manus-storage/safe-aca-04-bts-diploma-oriented_d4c065c3.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Langues : arabe, français, anglais, espagnol", "Mathématiques et gestion des entreprises"], skills:["Gestion PME", "Organisation", "Communication"], isDiploma:true },
  { id:"ACA-05-BTS-RECORD", title:"BTS Gestion PME/PMI — relevé de notes", source:"Relevé de note BTS.jpg", preview:"/manus-storage/safe-aca-05-bts-record_50a794d3.jpg", download:"/manus-storage/safe-aca-05-bts-record_50a794d3.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Gestion comptable, financière, commerciale et administrative", "Communication et stage en entreprise"], skills:["Comptabilité", "Finance", "Gestion commerciale"] },
  { id:"ACA-06-BAC-FRONT", title:"Baccalauréat — recto", source:"BAC recto.jpg", preview:"/manus-storage/safe-aca-06-bac-front_fa7fbf2a.jpg", download:"/manus-storage/safe-aca-06-bac-front_fa7fbf2a.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Sciences physiques", "Mathématiques et sciences de la vie et de la terre"], skills:["Raisonnement scientifique", "Mathématiques", "Physique-chimie"], isDiploma:true },
  { id:"ACA-07-BAC-BACK", title:"Baccalauréat — verso", source:"BAC verso.jpg", preview:"/manus-storage/safe-aca-07-bac-back_419dddd3.jpg", download:"/manus-storage/safe-aca-07-bac-back_419dddd3.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Langues étrangères et philosophie", "Instruction islamique et éducation physique"], skills:["Langues", "Communication écrite", "Culture générale"], isDiploma:true },
  { id:"ACA-08-BAC-RECORD", title:"Baccalauréat — relevé de notes", source:"Relevé note BAC.jpg", preview:"/manus-storage/safe-aca-08-bac-record-oriented_6e586b0b.jpg", download:"/manus-storage/safe-aca-08-bac-record-oriented_6e586b0b.jpg", sections:["academic","registry"], previewRedressed:true, curriculum:["Physique-chimie, mathématiques et sciences de la vie", "Langues, philosophie et matières transversales"], skills:["Sciences physiques", "Analyse", "Méthode scientifique"] },
  ...
  { id:"MEM-01", title:"Mémoire de master — version PDF", source:"MFE CHERKI EL MEHDI 2025-2026.pdf", preview:"/manus-storage/mem-01-pdf-preview_77270393.png", download:"/manus-storage/mem-01-pdf_55a60195.pdf", sections:["thesis","registry"], summary:"Étude appliquée de l’usage du machine learning dans l’analyse et la gouvernance de la commande publique hospitalière." },
  { id:"MEM-02", title:"Mémoire de master — version DOCX", source:"MFE CHERKI EL MEHDI 2025-2026.docx", preview:"/manus-storage/mem-02-docx-preview_865ae155.png", download:"/manus-storage/mem-02-docx_8067ad2d.docx", sections:["thesis","registry"], summary:"Version éditable de l’étude appliquée sur le machine learning et la commande publique hospitalière." },
  { id:"MEM-03", title:"Présentation de soutenance", source:"MFE CHERKI EL MEHDI VF 07-07-2026.pptx", preview:"/manus-storage/mem-03-pptx-preview_3984b862.png", download:"/manus-storage/mem-03-pptx_0b406a2c.pptx", sections:["thesis","registry"], summary:"Synthèse de soutenance présentant le cadre, la démarche et les résultats du mémoire de master." },
