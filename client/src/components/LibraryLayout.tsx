...
export default function LibraryLayout({ locale, setLocale, children }: { locale: Locale; setLocale: (locale: Locale) => void; children: ReactNode }) {
  ...
  return <div className={locale === "ar" ? "library-app rtl" : "library-app"}>
    <aside className="library-sidebar">
      ...
      <div className="sidebar-note"><ShieldCheck size={15} /><p>CV / STRUCTURATION<br />ZIP / PREUVES</p></div><a className="sidebar-export" href="/manus-storage/cherki-el-mehdi-public-dossier_0f520306.zip" download><ArchiveIcon size={14} /> EXPORT PUBLIC .ZIP</a>
